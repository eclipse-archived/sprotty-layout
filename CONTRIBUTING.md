 ...
 * [GitHub issues](https://github.com/eclipse/sprotty-layout/issues) - for bug reports, feature requests, etc.
...
In case you have a question, please look into the [documentation in the Wiki](https://github.com/eclipse/sprotty-layout/wiki) first. If you don't find any answer there, feel free to use the chat, forum or issues to get help.
